...
class SettingsManager {
  ...
  async load(): Promise<void> {
    ...
    if (envKey) {
      this.current = { geminiApiKey: envKey, model: envModel, fastModel: envFastModel };
      this.source = 'env';
      return;
    }
  ...
  getStatusMessage(): string {
    ...
    return `Configured (source: ${this.source}, key: ${masked}, model: ${this.getModel()}, fastModel: ${this.getFastModel()})`;
  }
}
